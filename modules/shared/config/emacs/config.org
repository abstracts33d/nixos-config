...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "abstracts33d"
    user-mail-address "abstract.s33d@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/s33d/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/s33d/bin" "/profile/bin" "/Users/s33d/.npm-packages/bin" "/Users/s33d/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
